...
$pkgZip = "opensearch_agents\installer\windows_setup\package.zip"
if (Test-Path $pkgZip) {
...
$bootstrapAbs = (Resolve-Path "opensearch_agents\installer\windows_setup\setup_bootstrap.py").Path

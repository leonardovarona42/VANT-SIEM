...
class DlpPolicyForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'scan_paths': forms.Textarea(attrs={'rows': 3, 'placeholder': 'One path per line, e.g.: C:\\Users\\n/home/'}),
            'monitored_extensions': forms.Textarea(attrs={'rows': 2, 'placeholder': 'One extension per line, e.g.: .docx\\n.pdf'}),
        }

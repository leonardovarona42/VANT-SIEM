...
class Settings:
    SERVICE_HOST = os.getenv("OS_SERVICE_HOST", "0.0.0.0")
    SERVICE_PORT = int(os.getenv("OS_SERVICE_PORT", "9201"))

    DB_HOST = os.getenv("OS_DB_HOST", "127.0.0.1")
    DB_PORT = int(os.getenv("OS_DB_PORT", "5433"))
    DB_NAME = os.getenv("OS_DB_NAME", "vant_opensearch")
    DB_USER = os.getenv("OS_DB_USER", "os_user")
    DB_PASSWORD = os.getenv("OS_DB_PASSWORD", "os_pass")

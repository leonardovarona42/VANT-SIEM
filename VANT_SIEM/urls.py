...
urlpatterns = [
    ...
    path('devices/network-management/', views.network_management_dashboard, name='network-management'),
    path('devices/network-management/sites/create/', views.network_site_create, name='network-site-create'),
    path('devices/network-management/vlans/create/', views.network_vlan_create, name='network-vlan-create'),
    path('devices/network-management/subnets/create/', views.network_subnet_create, name='network-subnet-create'),
    path('devices/network-management/ips/create/', views.network_ip_create, name='network-ip-create'),
    ...
    path('devices/dlp/incidents/feed/', views.dlp_incident_feed, name='dlp-incident-feed'),
    path('devices/dlp/incidents/<int:incident_id>/preview/', views.dlp_incident_preview, name='dlp-incident-preview'),
    path('devices/dlp/incidents/<int:incident_id>/report/', views.dlp_incident_report, name='dlp-incident-report'),
